...
<section class="content">
  <div class="box">
    <div class="box-header with-border">
      <h4 class="box-title text-capitalize">Data tahun_ajaran</h4>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group mb-3">
                ...
                <input type="number" id="tahun" name="tahun" class="form-control" placeholder="Tahun" minlength="0" maxlength="11" required>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group mb-3">
